...
String [] filenames = {"bench_1.mp3", "bench_2.mp3", "bench_3.mp3", "bench_4.mp3", "bench_5.mp3", "bench_6.wav"};
...
void setup() {
  ...
  imageMode(CENTER);
  noStroke();
  img = loadImage("plante4_pic.png");
  soundfiles = new SoundFile[filenames.length];
  
  for (int i = 0; i < soundfiles.length; i++){
    println(filenames.length, i, filenames[i]);
