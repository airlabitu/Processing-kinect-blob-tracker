...
final static String[] instrumentFiles = {
  "Bass", "Drum_Stand", "Drums", "Guitar", "Piano_Bells", "Strings", "Vocals_Marvin", "Vocals_Tammi"
};
...
boolean mouseControl, follow, showUserOutline = true, whiteFill, blend = true;
...
void oscEvent(OscMessage theOscMessage) {
  ...
  println("coords:" + globalX, globalY);
}
